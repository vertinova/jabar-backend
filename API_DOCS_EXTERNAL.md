...
```
POST /api/external/rekomendasi/:id/poster
...
Endpoint ini mengupdate kolom `poster` pada DB Jabar agar poster juga tampil di landing Jabar. Dapat dipakai oleh FORBASI pusat untuk sync/dual-write poster manual.
